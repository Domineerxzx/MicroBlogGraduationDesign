package com.domineer.triplebro.microbloggraduationdesign.database;
 ...
 */
public class MicroBlogDataBase extends SQLiteOpenHelper {
    public MicroBlogDataBase(@Nullable Context context) {
        super(context, "MicroBlogDataBase", null, 1);
    }
